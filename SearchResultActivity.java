...
public class SearchResultActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    String MY_URL_STRING= "http://192.168.0.17/gettingdata/searchResult.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marketBtn.setOnClickListener(v -> {
            Intent intent0= new Intent(SearchResultActivity.this, MarketPosts.class);  ///the transition between this activity and the next
        ...
        createPost.setOnClickListener(v -> {
            ...
            Intent intent0= new Intent(SearchResultActivity.this, CreatePost.class);  ///the transition between this activity and the next
            startActivity(intent0);  // Start the new activity
            finish();
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.itemLogout: {
                Intent intent0= new Intent(SearchResultActivity.this, MainActivity.class);  ///the transition between this activity and the next
                startActivity(intent0);  // Start the new activity
                finish();
                break;
            }
    ...
    public void sendPostRequest (View v){
        new SearchResultActivity.PostClass(this).execute();
    }
    ...
    public void onBackPressed(){
        if(drawerLayout.isDrawerOpen(GravityCompat.START)){
            ...
            Intent intent0 = new Intent(SearchResultActivity.this, posts.class);
            startActivity(intent0);  // Start the new activity
            finish();
        }
