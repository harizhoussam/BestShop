...
public class CreateMarketPost extends AppCompatActivity {
    ...
    private final String MY_URL_STRING = "http://192.168.0.17/gettingdata/creatingMarketPost.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_create_market_post);
...
/*        map.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
        ...
        postBtn.setOnClickListener(v -> {
            if (photo != null) {
                ...
                if(text.length() > 20){
                    ...
                    } else Toast.makeText(CreateMarketPost.this, "Couldn't get location", Toast.LENGTH_SHORT).show();
                } else Toast.makeText(CreateMarketPost.this, "Write proper description", Toast.LENGTH_SHORT).show();
            } else Toast.makeText(CreateMarketPost.this, "Add photo", Toast.LENGTH_SHORT).show();
        ...
        addImage.setOnClickListener(v -> {
            ...
            try {
                ...
                if (imageIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(CreateMarketPost.this, "Camera isn't working", Toast.LENGTH_SHORT).show();
            } catch (Exception ex) {
    ...
    public void onBackPressed () {
        Intent intent0 = new Intent(CreateMarketPost.this, MarketPosts.class);  ///the transition between this activity and the next
    ...
    public void sendPostRequest (View v){
        new CreateMarketPost.PostClass(this).execute();
    }
    ...
    class PostClass extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... arg0) {
            ...
            try {
                Log.i("a", "ConvertImage is " + ConvertImage);
                ...
                CreateMarketPost.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    public void getLocation(){
        if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            ActivityCompat.requestPermissions(CreateMarketPost.this,
        ...
        }else
        {
            ...
            LocationServices.getFusedLocationProviderClient(CreateMarketPost.this).requestLocationUpdates
                    (locationRequest, new LocationCallback() {
                        @Override
                        public void onLocationResult(@NonNull LocationResult locationResult) {
                            super.onLocationResult(locationResult);
                            LocationServices.getFusedLocationProviderClient(CreateMarketPost.this).removeLocationUpdates(this);
                            if(locationResult != null &&  locationResult.getLocations().size() > 0){
                                ...
                                // String lon ="30.766532";

                                //String map = ("geo:" + lat + "," + lon);
                                String specificloc = ("geo:" + lat + "," + lon + "?q="+lat+ "," +lon);
                                // intent.setData(Uri.parse("geo:<lat>,<long>?q=<lat>,<lon>"));
